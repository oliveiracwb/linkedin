...
# (str) Package name
package.name = visao2.showcase.israeloliveira2035.com

# (str) Package domain (needed for android/ios packaging)
package.domain = israeloliveira2035.com

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,dat,kv,pyc,ttf,xml,png,jpeg
...
source.exclude_dirs = tests, bin, final, build, img, bkp, old, bkp
